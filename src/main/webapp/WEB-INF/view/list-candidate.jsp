...
<body>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a class="navbar-brand"
						href="${pageContext.request.contextPath}/homeCompany?userId=${company.userId}">Trang
							chủ</a></li>
					<li class="nav-item"><a
					...
					<li class="nav-item dropdown"><a href="#"
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><c:url var="updateCompany" value="/updateProfileCompany">
								</c:url> <form:form action="${updateCompany}" method="GET">
					...
					<li><c:url var="createJob" value="/createJob">
							...
							<a
								href="${pageContext.request.contextPath}/createJob?userId=${company.userId}"
	...
	<c:forEach var="tempUser" items="${userJobInfoList}">
		<ul>
			...
			<li>Công việc ứng tuyển: ${tempUser.jobName}</li>
